...
import 'package:tutorial/screens/comments_screen.dart';
import 'package:tutorial/utils/colors.dart';
import 'package:tutorial/utils/utils.dart';
import 'package:tutorial/widgets/like_animation.dart';
...
class _PostCardState extends State<PostCard> {
  ...
  Widget build(BuildContext context) {
   final model.User user = context.watch<UserProvider>().getUser;
    return Container(
