...
class DatabaseMethods {
  ...
  Future addMessage(String chatRoomId, messageId, Map<String, dynamic> messageInfoMap)
  async {
    return FirebaseFirestore.instance
  ...
  createChatRoom(String chatRoomId, Map<String, List> chatRoomInfoMap) async {
